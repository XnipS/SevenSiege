...
public class oxideNetworkManager : NetworkManager
{
	...
	void Update()
	{
		if (FindObjectOfType<oxideNetworkManagerHUD>() != null)
		{
			if (loadingSceneAsync != null)
			{
				FindObjectOfType<oxideNetworkManagerHUD>().menu.SetActive(false);
				FindObjectOfType<oxideNetworkManagerHUD>().loading.SetActive(true);
				FindObjectOfType<oxideNetworkManagerHUD>().loadingBar.value = loadingSceneAsync.progress;

			}
			else
			{
				FindObjectOfType<oxideNetworkManagerHUD>().menu.SetActive(true);
				FindObjectOfType<oxideNetworkManagerHUD>().loading.SetActive(false);
			}
		}
	}
